...
*
* This sketch shows how to use two ADS1220 modules attached to the two 
* separate SPI interfaces. This sketch was tested on an ESP32 Dev Board.
* 
***************************************************************************/
...
// Pin definitions
#define ADS1220_1_CS_PIN    5   // Chip Select
#define ADS1220_1_DRDY_PIN  17   // Data Ready

#define ADS1220_2_CS_PIN    15   // Chip Select
#define ADS1220_2_DRDY_PIN  16   // Data Ready

SPIClass SPI_2(HSPI); // create SPI_2 object

// Create ADS1220 objects
ADS1220_WE ads1 = ADS1220_WE(&SPI, ADS1220_1_CS_PIN, ADS1220_1_DRDY_PIN);
ADS1220_WE ads2 = ADS1220_WE(&SPI_2, ADS1220_2_CS_PIN, ADS1220_2_DRDY_PIN);
